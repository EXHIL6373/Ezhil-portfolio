                    ...
                    <ul className="list-disc list-inside text-gray-300 space-y-2">
                        <li>
                            <strong>B.Tech Artificial Intelligence And Data Science</strong>
                             - V.S.B College Of Engineering Technical Campus(2022-2026)
                        </li>
                        <li>
                            Relevent CourseWork: Data Analytics, Web Development
                        </li>
                    </ul>
                </div>
                <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                    ...
                    <div className="space-y-4 text-gray-300 ">
                        <div>
                            <h4 className="font-semibold"> Intern at NoviTech R&D pvt (2024) </h4>
                            <p>
                                Created a Video-Streaming Web Application with full-stack
                            </p>
